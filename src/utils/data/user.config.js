...
const user = {
  ...
  skills: [
    ...
    },
    {
      ...
      values: [ "NodeJS", "ExpressJS", "MongoDB"],
    },
    {
      name: "Games",
      values: ["Chess", "Carrom" ],
